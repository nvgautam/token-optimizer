...
| Token savings validation | RESOLVED | Root cause of missing savings identified 2026-06-26: deployed skills were pre-T-026/T-027 stale versions (oracle 232L vs 126L; orchestrate 422L vs 140L). Synced. Pass criterion: next oracle session context ≤15% at re-spar point (vs 24% observed with stale skills). Validate empirically in next session. |
