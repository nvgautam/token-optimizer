...
| Round M-F-20 [PENDING] | T-338 ‖ T-339 (parallel) | Oracle write guard hook + SPIKE: orchestrator lifecycle state variables |
| Round M-F-21 [PENDING] | T-340 (solo) | Interactive select menu for human gate PR reviews |
