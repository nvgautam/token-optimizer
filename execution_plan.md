...
| Round C-state — MERGED | T-278 | Orchestrate resume: derive next round from execution_plan.md Master Round Table, not state.json — state.json is stale when tasks are prepended after last merge |
